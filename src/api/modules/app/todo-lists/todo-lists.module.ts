...
import { NotifySlackWhenTodoItemCompletedDomainEventHandler } from '@application/todo-lists/event-handlers/notify-slack-when-todo-item-completed.domain-event-handler';
...
@Module({
  imports: [CqrsModule, SlackModule],
  controllers: [
  ...
  providers: [
    ...
    NotifySlackWhenTodoItemCompletedDomainEventHandler,
  ],
})
